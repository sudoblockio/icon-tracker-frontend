...
class BlockInfo extends Component {
  ...
  handleNextBlock = async () => {
    ...
    try {
      const lastBlockResp = await getLastBlock();

      if (lastBlockResp.height > number + 1) {
                  ...
                  <table className="table-typeB detail">
                    <tbody>
                      ...
                      <tr>
                        <td>Transactions</td>
                        <td>
                          <span onClick={this.goAllTx}>{numberWithCommas(transaction_count)} Transaction(s)</span> in
                          this block
                        </td>
                      </tr>
                      <tr>
