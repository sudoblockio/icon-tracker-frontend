                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td className={scam ? 'scam' : ''}>
                                                    {scam ? (
                                                        <span className="scam-tag">Reported</span>
                                                    ) : (
                                                        ''
                                                    )}
                                                    {hash}
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    onClick={() =>
                                                        isFail &&
                                                        window.open(`/transaction/trace/${hash}`)
                                                    }
                                                    className={isFail ? 'fail' : ''}>
                                                    {' '}
                                                    {isSuccess ? 'Success' : 'Fail'}{' '}
                                                    {isFail && `- ${this.state.msgList}`}
                                                    <span
                                                        className={'btn-scam'}
                                                        onClick={() =>
                                                            window.open(
                                            ...
                                            {recentTokenTx &&
                                                ...
                                                <tr>
                                                    ...
                                                    <TokenTransferCell
                                                        tokenTxList={recentTokenTx.data}
                                                    />
                                                </tr>
                                            ...
                                            <tr>
                                                <td>Step Price</td>
                                                <td>
                                                    {convertNumberToText(stepPriceIcx)} ICX
                                                    <em>
                                                        ({convertNumberToText(stepPriceGloop)}{' '}
                                                        Gloop)
                                                    </em>
                                                </td>
                                            </tr>
                                            ...
                                            {data_type && dataString ? (
                                                <tr>
                                                    ...
                                                    <DataCell
                                                        ...
                                                        imageConverterPopup={
                                                            this.props.imageConverterPopup
                                                        }
                                                    />
                                                </tr>
                                            ) : null}
...
class DataCell extends Component {
    ...
    render() {
        ...
        const buttonTitle = viewHex
            ? `Convert to ${_isImageData ? 'Image' : 'UTF-8'}`
            : 'Convert to HEX'
        return (
                ...
                {tokenTxListSliced.map((tokenTx, index) => {
                    ...
                    return (
                        <p key={index}>
                            ...
                            <AddressLink
                                to={from_address}
                                label={<span className="ellipsis">{from_address}</span>}
                            />
                            &emsp;to&emsp;
                            <AddressLink
                                to={to_address}
                                label={<span className="ellipsis">{to_address}</span>}
                            />
                        </p>
                    )
                })}
...
class InternalTx extends Component {
    ...
    render() {
        ...
        const internalTxListSliced =
            isMoreTen && !more ? internalTxList.slice(0, COUNT) : internalTxList
        ...
        return (
            <div>
                {internalTxListSliced.map((tx, index) => {
                    ...
                    return (
                        <p key={index}>
                            ┗&emsp;TRANSFER {convertHexToValue(value).toFixed(4)} ICX &emsp;from
                            &emsp;
                            <span>
    ...
    if (isAddress) {
        return (
            <AddressCell
                ...
                InternalDiv={
                    internalTxList &&
                    internalTxList.length !== 0 && <InternalTx internalTxList={internalTxList} />
                }
            />
        )
    } else {
