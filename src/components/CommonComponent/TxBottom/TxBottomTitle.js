                    ...
                    return (
                        <p className="txt">
                            <span>
                                ...
                                <em className="mint" onClick={goAllTx}>
                                    {numberWithCommas(totalSizeNum)} Voter(s)
                                </em>
                            </span>
                        </p>
                    )
                    ...
                    return (
                        <p className="txt">
                            <span>
                                ...
                                <em className="mint" onClick={goAllTx}>
                                    {numberWithCommas(totalSizeNum)} reward(s)
                                </em>
                            </span>
                        </p>
                    )
                    ...
                    return (
                        <p className="txt">
                            <span>
                                Latest<em>{listSizeNum}</em> Txn(s) from a total of
                                <em className="mint" onClick={goAllTx}>
                                    {_totalSize} internal transaction(s)
                                </em>
                            </span>
                        </p>
                    )
                    ...
                    return (
                        <p className="txt">
                            <span>
                                Latest<em>{listSizeNum}</em> Txn(s) from a total of
                                <em className="mint" onClick={goAllTx}>
                                    {Number(this.props.total).toLocaleString('en-US')}{' '}
                                    transaction(s)
                                </em>
                            </span>
                        </p>
                    ...
                    return (
                        <p className="txt">
                            <span>
                                ...
                                <em className="gray">(from a total of {_totalSize} holder(s))</em>
                            </span>
                        </p>
                    )
                        ...
                        <p className="txt">
                            {
                                <span>
                                    ...
                                    <AddressLink
                                        to={fromAddr}
                                        label={<em className="mint ellipsis">{fromAddr}</em>}
                                    />{' '}
                                    To
                                    <AddressLink
                                        to={toAddr}
                                        label={<em className="mint ellipsis">{toAddr}</em>}
                                    />
                                </span>
                            }{' '}
