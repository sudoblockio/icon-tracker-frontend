...
function ProposalDetailPage(props) {
    ...
    const buttonLabel = !votedAgree && !votedDisagree ? 'Cast Vote' : 'Change Vote'
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <Link to={`/transaction/${id}`}>
                                                    <span className="link proposal-pointer">
                                                        {id}
                                                    </span>
                                                </Link>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    ...
                                                    ref={(ref) => {
                                                        if (ref)
                                                            ref.innerHTML = closeEm(description)
                                                    }}></span>
                                            </td>
                                        </tr>
                                        <tr>
