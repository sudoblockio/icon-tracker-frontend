                                    ...
                                    <tbody>
                                            ...
                                            {isCreator && isCreateTx ? (
                                                <td>
                                                    ...
                                                    <span
                                                        ...
                                                        <AddressLink
                                                            to={contractDetails.owner_address}
                                                        />
                                                    </span>
                                                    <em>at Txn</em>
                                                    <span
                                        ...
                                        {verified_data ? (
                                            <tr>
                                                ...
                                                <td>
                                                    {verified_data
                                                        ? verified_data.short_description
                                                        : ''}
                                                </td>
                                            </tr>
                                        ) : (
...
class TokenContractCell extends Component {
    render() {
        const { tokenName, symbol, address, ircVersion, onMouseOver, onMouseOut, isToken } =
            this.props
        const Content = () => {
            if (isToken) {
                return (
