...
function ReadMethodItems({ methods, params, handleChange, handleClick, address, startIndex = 0 }) {
    return (
        <ul className="list">
...
function WriteMethodItems({ methods, params, handleChange, handleClick, address, startIndex = 0 }) {
    return (
        <ul className="list">
        ...
        <div
            ...
            <div className={styles.writeMethodBody}>
                    ...
                    methodInput.inputs.map((input, index2) => {
                        ...
                        return (
                            <div
                                ...
                                <div className={styles.writeMethodBodyInputName}>{placeholder}</div>
                ...
                {(methodInput.inputs.length > 0 || alwaysShowButton) && (
                    <div className={styles.methodInputButtonContainer}>
                        <button className={styles.methodInputButton} onClick={handleButtonClick}>
                            Query
                        </button>
                    </div>
                )}
            ...
            {resultIsOpen && methodOutput.state > 0 && (
                <div
                    ...
                    <p>Response:</p>
                    <p className={styles.writeMethodBodyOutputResponseContent}>{responseState}</p>
                </div>
            )}
        </div>
    )
