						...
						<div className="content">
							<div className="proposal-list">
								{proposals.map(proposal => {
									...
									const noVoteCount = 100 - agreeCount - disagreeCount
									const agreeAmount = ((agree.amount / allAmount) * 100).toFixed()
									const disagreeAmount = ((disagree.amount / allAmount) * 100).toFixed()
									// const noVoteAmount = 100 - agreeAmount - disagreeAmount
									return (
										<ul key={id} className='proposal-pointer' onClick={() => { this.props.history.push('/proposal/' + id) }}>
											<li>
												...
												<div>
													<span className={`proposal-status ${ProposalStatusClass[status]}`}>{ProposalStatus[status]}</span><h3>Proposed by <span>{proposerName}</span></h3>
												</div>
											</li>
											<li>
											...
											<li>
												...
												<div className="bar-wrap">
													<div className="bar-container">
														<div className="bar-foreground" style={{ height: `${agreeCount}%`, top: `${noVoteCount}%` }}>
															{(VIEW_NUMBER || agreeCount >= 30) && <span><em>{agreeCount}</em>%</span>}
														</div>
														<div className="bar-background" style={{ height: `${disagreeCount}%`, top: `${noVoteCount}%` }}>
											...
											<li>
												...
												<div className="bar-wrap">
													<div className="bar-container">
														<div className="bar-foreground" style={{ height: `${agreeAmount}%` }}>
														...
														<div className="bar-background" style={{ height: `${disagreeAmount}%` }}>
