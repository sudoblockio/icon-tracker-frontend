...
const apiEndpoint =
  process.env.REACT_APP_API_ENDPOINT || defaultSettings["apiEndpoint"];
const rpcEndpoint =
  process.env.REACT_APP_RPC_ENDPOINT || defaultSettings["rpcEndpoint"];
const wssEndpoint =
  process.env.REACT_APP_WSS_ENDPOINT || defaultSettings["wssEndpoint"];
