...
export function getAddressesApi(payload) {
  ...
  return new Promise((resolve, reject) => {
    trackerApi.get('/v0/wallet/addrList?page=' + pageNum)
      .then(result => {
        resolve(result.data)
      })
      .catch(error => {
...
export function getAddressDetailApi(payload) {
  ...
  return new Promise((resolve, reject) => {
    trackerApi.get('/v0/wallet/walletDetailTxList?address=' + addressId + '&page=' + pageId + '&count=' + count)
    // trackerApi.get('/v3/address/info?address=' + addressId + '&page=' + pageId)
      .then(result => {
        console.log(result)
        resolve(result.data)
      })
...
export function getBlocksApi(payload) {
  const pageNum = payload || 1
  return new Promise((resolve, reject) => {
    trackerApi.get('/v0/block/recentBlock?page=' + pageNum)
      .then(result => {
        console.log(result)
        resolve(result.data)
      })
...
export function getBlockApi(payload) {
  ...
  return new Promise((resolve, reject) => {
    trackerApi.get('/v0/block/blockDetail?height='+blockId+'&page='+pageId )
      .then(result => {
        resolve(result.data)
      })
      .catch(error => {
...
export function getBlockByHashApi(payload) {
  ...
  return new Promise((resolve, reject) => {
    trackerApi.get('/v0/block/blockDetailByHash?hash='+blockHash+'&page='+pageId )
      .then(result => {
        resolve(result.data.data)
      })
      .catch(error => {
...
export function searchApi(payload) {
  return new Promise((resolve, reject) => {
    trackerApi.get('/v0/search/Search?data=' + payload)
      .then(result => {
        resolve(result.data.data)
      })
      .catch(error => {
