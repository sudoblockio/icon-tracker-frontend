...
class AddressPage:
    ...
    def verify_bonded_page_table(self):
        """
                    verify_bonded_page_table
                    -this method is used to verify on the bonded table
                """
    ...
    def verify_all_links_in_transaction_new_address_url(self, count):
        """
                verify_all_links_in_transaction_new_address_url
                -this method is used to verify all the links present in transaction tab is working as expected in
