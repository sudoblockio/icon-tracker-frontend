...
# python -m pytest -v -s -m "address_page" --html=e2e/reports/report.html --capture=tee-sys e2e/testCases/address_page_test
...
# python -m pytest -v -s -m "standalone" --html=e2e/reports/report.html --capture=tee-sys e2e/testCases --disable-warnings
 pytest -v -s -m "main_page and address_page and contract_page and governance" --html=e2e/reports/report.html --capture=tee-sys e2e/testCases/
